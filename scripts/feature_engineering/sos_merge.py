...
player_df = pd.read_csv("player_season_with_snaps_with_epa.csv")

# === Step 2: Load SoS win percentage data ===
sos_df = pd.read_csv("sos_win_pct_2018_2024.csv")
...
merged_df.to_csv("player_season_with_epa_and_sos.csv", index=False)
